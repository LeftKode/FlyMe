...
public class DestLocationFinderTask extends AsyncTask<String, Void, String> {

    public DestinationResponse delegate = null;
    ...
    public void onPostExecute(String result){
        delegate.GiveMyDestinationAirportName(result);
    }
